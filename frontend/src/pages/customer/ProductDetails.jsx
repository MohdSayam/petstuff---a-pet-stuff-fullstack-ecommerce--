            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-20">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <div className="flex items-end gap-4 mb-8">
                        ...
                        {product.discountPercentage > 0 && (
                            <div className="flex flex-col mb-2">
                                ...
                                <span className="text-xs font-bold text-red-500 uppercase">Save ${(product.originalPrice - product.salePrice).toFixed(2)}</span>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-8 pt-8 border-t border-slate-100">
                        <div className="flex items-center gap-3 text-slate-500"><Truck size={20} className="text-brand-primary"/><span className="text-xs font-bold uppercase tracking-wider">Free Shipping over $100</span></div>
