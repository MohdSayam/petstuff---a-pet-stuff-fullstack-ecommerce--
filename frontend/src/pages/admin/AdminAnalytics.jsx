...
function AdminAnalytics() {
    ...
    //safety check - show empty state if no data
    if (!data) {
        return (
            <div className='flex flex-col items-center justify-center py-20 animate-in fade-in duration-500'>
                ...
                <h2 className='text-2xl font-black text-slate-800 mb-2'>No Analytics Yet</h2>
                <p className='text-slate-500 text-center max-w-md mb-8'>
                    Create a store and add products to start seeing your sales and inventory analytics.
                </p>
            </div>
        );
    }
